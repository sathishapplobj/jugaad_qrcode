...
namespace Drupal\jugaad_app_qr_code\Response;
 ...
 *
 * @package Drupal\jugaad_app_qr_code\Response
 */
class QRImageResponse extends Response {
  ...
  private function generateQrCode(string $string = '') {
    $logoPath = drupal_get_path('module', 'jugaad_app_qr_code') . '/images/symfony.png';
