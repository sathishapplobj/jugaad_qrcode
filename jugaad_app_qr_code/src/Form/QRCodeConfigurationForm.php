...
namespace Drupal\jugaad_app_qr_code\Form;
...
class QRCodeConfigurationForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'jugaad_app_qr_code_admin_settings';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('jugaad_app_qr_code.settings');
    $form['logo_width'] = [
      '#type' => 'range',
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('jugaad_app_qr_code.settings')
